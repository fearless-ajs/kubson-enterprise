...
$total_count = Men::count_men_by_cat("Shoes");
...
//for this page
$sql  = "SELECT * FROM men WHERE category = 'Shoes' ";
$sql .= "LIMIT {$per_page} ";
...
//3. total record count ($total_count)
$cloth_total_count = Men::count_men_by_cat("Clothes");
...
//instead of finding all records, just find the record
//for this page
$cloth_sql  = "SELECT * FROM men WHERE category = 'Clothes' ";
$cloth_sql .= "LIMIT {$cloth_per_page} ";
$cloth_sql .= "OFFSET {$cloth_pagination->offset()}";
$Cloth_items = Men::find_by_sql($cloth_sql);
...
//3. total record count ($total_count)
$bags_total_count = Men::count_men_by_cat("Bags");
...
//instead of finding all records, just find the record
//for this page
$bags_sql  = "SELECT * FROM men WHERE category = 'Bags' ";
$bags_sql .= "LIMIT {$cloth_per_page} ";
$bags_sql .= "OFFSET {$cloth_pagination->offset()}";
$bags_items = Men::find_by_sql($bags_sql);
...
//3. total record count ($total_count)
$watches_total_count = Men::count_men_by_cat("Watches");
...
//instead of finding all records, just find the record
//for this page
$watches_sql  = "SELECT * FROM men WHERE category = 'Watches' ";
$watches_sql .= "LIMIT {$watches_per_page} ";
$watches_sql .= "OFFSET {$watches_pagination->offset()}";
$watches_items = Men::find_by_sql($watches_sql);
...
<div class="page-head">
	<div class="container">
		<h3 style="color: white;">Men Wears</h3>
	</div>
</div>
		...
		<div class="sap_tabs">
			<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
				<ul class="resp-tabs-list">
					<li class="resp-tab-item" aria-controls="tab_item-0" role="tab" style="border-color: #3b5998;"><span>Men Shoes</span></li> 
					<li class="resp-tab-item" aria-controls="tab_item-1" role="tab"><span>Men Clothes</span></li> 
					<li class="resp-tab-item" aria-controls="tab_item-2" role="tab"><span>Men Bags</span></li> 
                                        <li class="resp-tab-item" aria-controls="tab_item-2" role="tab"><span>Men Watches</span></li> 
				</ul>				  	 
					...
					<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
						...
						<div class="col-md-3 product-men yes-marg">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
                                                                    <h4><a href="view_men.php?key=<?php echo $item->id; ?>" style="color: #3b5998;"><?php echo $item->name; ?></a></h4>
									<div class="info-product-price">
										<span class="item_price">#<?php echo $item->price; ?></span>
										<del>#<?php echo $item->price + 3000; ?></del>
									</div>
                                                                        <a href="men_wears.php?cartId=<?php echo $productId; ?>&&cartSize=<?php echo $productSize; ?>&&cartName=<?php echo $productName; ?>&&cartQuantity=<?php echo $quantity; ?>&&cartPrice=<?php echo $productPrice; ?>&&cartImage=../admin/public/<?php echo $productImage; ?>" class="item_add single-item hvr-outline-out button2">Add to cart</a>									
								</div>
							</div>
						</div>
                        ...
                        if($pagination->total_pages() > 1){
                            ...
                            if($pagination->has_prevoius_page()){
                                echo "<a href=\"men_wears.php?page=";
                            ...
                            for($i=1; $i <= $pagination->total_pages(); $i++){
                                if($i == $page){
                                    ...
                                    echo " <a href=\"men_wears.php.?page={$i}\">{$i}</a> ";
                                }
					  ...
					  <?php 
                        ...
                        if($cloth_pagination->total_pages() > 1){
                            ...
                            if($cloth_pagination->has_prevoius_page()){
                                echo "<a href=\"men_wears.php?cloth_page=";
                            ...
                            for($i=1; $i <= $cloth_pagination->total_pages(); $i++){
                                if($i == $cloth_page){
                                    ...
                                    echo " <a href=\"men_wears.php.?cloth_page={$i}\">{$i}</a> ";
                                }
					  ...
					  <?php 
                        ...
                        if($bags_pagination->total_pages() > 1){
                            ...
                            if($bags_pagination->has_prevoius_page()){
                                echo "<a href=\"men_wears.php?bags_page=";
                            ...
                            for($i=1; $i <= $bags_pagination->total_pages(); $i++){
                                if($i == $bags_page){
                                    ...
                                    echo " <a href=\"men_wears.php.?bags_page={$i}\">{$i}</a> ";
                                }
					  ...
					  <?php 
						...
						<div class="col-md-3 product-men yes-marg">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									...
									<a href="men_wears.php?cartId=<?php echo $productId; ?>&&cartName=<?php echo $productName; ?>&&cartize=<?php echo $productSize ?>&&cartQuantity=<?php echo $quantity; ?>&&cartPrice=<?php echo $productPrice; ?>&&cartImage=../admin/public/<?php echo $productImage; ?>" class="item_add single-item hvr-outline-out button2">Add to cart</a>									
								</div>
							</div>
						</div>
                                            <?php endforeach; ?>
                        ...
                        if($watches_pagination->total_pages() > 1){
                            ...
                            if($watches_pagination->has_prevoius_page()){
                                echo "<a href=\"men_wears.php?watches_page=";
                            ...
                            for($i=1; $i <= $watches_pagination->total_pages(); $i++){
                                if($i == $watches_page){
                                    ...
                                    echo " <a href=\"men_wears.php.?watches_page={$i}\">{$i}</a> ";
                                }

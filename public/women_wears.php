...
$total_count = Women::count_men_by_cat("Shoes");
...
//for this page
$sql  = "SELECT * FROM women WHERE category = 'Shoes' ";
$sql .= "LIMIT {$per_page} ";
...
//3. total record count ($total_count)
$cloth_total_count = Women::count_men_by_cat("Clothes");
...
//instead of finding all records, just find the record
//for this page
$cloth_sql  = "SELECT * FROM women WHERE category = 'Clothes' ";
$cloth_sql .= "LIMIT {$cloth_per_page} ";
$cloth_sql .= "OFFSET {$cloth_pagination->offset()}";
$Cloth_items = Women::find_by_sql($cloth_sql);
...
//3. total record count ($total_count)
$bags_total_count = Women::count_men_by_cat("Bags");
...
//instead of finding all records, just find the record
//for this page
$bags_sql  = "SELECT * FROM women WHERE category = 'Bags' ";
$bags_sql .= "LIMIT {$cloth_per_page} ";
$bags_sql .= "OFFSET {$cloth_pagination->offset()}";
$bags_items = Women::find_by_sql($bags_sql);
...
//3. total record count ($total_count)
$watches_total_count = Women::count_men_by_cat("Watches");
...
//instead of finding all records, just find the record
//for this page
$watches_sql  = "SELECT * FROM women WHERE category = 'Watches' ";
$watches_sql .= "LIMIT {$watches_per_page} ";
$watches_sql .= "OFFSET {$watches_pagination->offset()}";
$watches_items = Women::find_by_sql($watches_sql);
...
<div class="page-head">
	<div class="container">
		<h3 style="color: white; ">Women Wears</h3>
	</div>
</div>
		...
		<div class="sap_tabs">
			<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
				<ul class="resp-tabs-list">
					<li class="resp-tab-item" aria-controls="tab_item-0" role="tab" style="border-color: #3b5998; "><span>Women Shoes</span></li> 
					<li class="resp-tab-item" aria-controls="tab_item-1" role="tab"><span>Women Clothes</span></li> 
					<li class="resp-tab-item" aria-controls="tab_item-2" role="tab"><span>Women Bags</span></li> 
                                        <li class="resp-tab-item" aria-controls="tab_item-2" role="tab"><span>Women Watches</span></li> 
				</ul>				  	 
					  ...
					  <?php 
						...
						<div class="col-md-3 product-men yes-marg">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4><a <a style="color: #3b5998;" href="view_women.php?key=<?php echo $item->id; ?>"><?php echo $item->name; ?></a></h4>
                        ...
                        if($pagination->total_pages() > 1){
                            ...
                            if($pagination->has_prevoius_page()){
                                echo "<a href=\"women_wears.php?page=";
                            ...
                            for($i=1; $i <= $pagination->total_pages(); $i++){
                                if($i == $page){
                                    ...
                                    echo " <a href=\"women_wears.php.?page={$i}\">{$i}</a> ";
                                }
					  ...
					  <?php 
                        ...
                        if($cloth_pagination->total_pages() > 1){
                            ...
                            if($cloth_pagination->has_prevoius_page()){
                                echo "<a href=\"women_wears.php?cloth_page=";
                            ...
                            for($i=1; $i <= $cloth_pagination->total_pages(); $i++){
                                if($i == $cloth_page){
                                    ...
                                    echo " <a href=\"women_wears.php.?cloth_page={$i}\">{$i}</a> ";
                                }
					  ...
					  <?php 
                        ...
                        if($bags_pagination->total_pages() > 1){
                            ...
                            if($bags_pagination->has_prevoius_page()){
                                echo "<a href=\"women_wears.php?bags_page=";
                            ...
                            for($i=1; $i <= $bags_pagination->total_pages(); $i++){
                                if($i == $bags_page){
                                    ...
                                    echo " <a href=\"women_wears.php.?bags_page={$i}\">{$i}</a> ";
                                }
					  ...
					  <?php 
                        ...
                        if($watches_pagination->total_pages() > 1){
                            ...
                            if($watches_pagination->has_prevoius_page()){
                                echo "<a href=\"women_wears.php?watches_page=";
                            ...
                            for($i=1; $i <= $watches_pagination->total_pages(); $i++){
                                if($i == $watches_page){
                                    ...
                                    echo " <a href=\"women_wears.php.?watches_page={$i}\">{$i}</a> ";
                                }

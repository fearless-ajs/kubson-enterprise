                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            Add New Product For Men
                        </header>
                        <div class="panel-body">
                            <div class="position-center">
                                <form role="form" action="add_men.php" enctype="multipart/form-data" method="post">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <input type="number" name="size" class="form-control" min="1" oninput="validity.valid||(value='1');" id="exampleInputEmail1" placeholder="Enter email">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Price</label>
                                        <input type="number" name="price" class="form-control" min="1" oninput="validity.valid||(value='1');" id="exampleInputEmail1" placeholder="Enter email">
                                    </div>
                                     <div class="form-group">

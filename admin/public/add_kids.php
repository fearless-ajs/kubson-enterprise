                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            Add New Item For Kids
                        </header>
                        <div class="panel-body">
                            <div class="position-center">
                                <form role="form" action="add_kids.php" enctype="multipart/form-data" method="post">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <input type="number" name="size" min="1" oninput="validity.valid||(value='1');" class="form-control" id="exampleInputEmail1" placeholder="Enter email">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Price</label>
                                        <input type="number" name="price" min="1" oninput="validity.valid||(value='1');" class="form-control" id="exampleInputEmail1" placeholder="Enter email">
                                    </div>
                                     <div class="form-group">

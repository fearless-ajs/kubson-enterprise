...
//Deleting Ward
$item_control = new WomenControl();
//Deleting Item
if($item_control->deleteItem()){
redirect_to('women_list.php');
}
          ...
          "enabled": true
                        ...
                        <?php foreach ($items as $item): ?>
                            <tr data-expanded="true">
                                ...
                                <td><a href="women_update.php?key=<?php echo $item->id;?>"><button type="submit" class="btn btn-send">View</button></a> </td>
                                <td><a href="women_list.php?del_key=<?php echo $item->id;?>"><button type="submit" class="btn btn-danger">Delete</button></a></td>
                            </tr>
                    ...
                    <div id="pagination" style="clear: both; ">
                        ...
                        if($pagination->total_pages() > 1){
                            ...
                            if($pagination->has_prevoius_page()){
                                echo "<a href=\"women_list.php?page=";
                            ...
                            for($i=1; $i <= $pagination->total_pages(); $i++){
                                if($i == $page){
                                    ...
                                    echo " <a href=\"women_list.php.?page={$i}\">{$i}</a> ";
                                }

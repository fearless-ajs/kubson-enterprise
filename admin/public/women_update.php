                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="position-center">
                                <form role="form" action="women_update.php?del_key=<?php echo $_GET['key']; ?>" method="post">
				...
				<script src="js/lightbox-plus-jquery.min.js"> </script>
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-offset-2 col-lg-10">
                                            <a class="btn btn-danger"href="women_update.php?del_key=<?php echo $item->id;?>">Delete this product from stock</a>

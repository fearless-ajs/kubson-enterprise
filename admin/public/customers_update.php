...
$staff = Customers::find_by_id($_GET['key']);
if(!$staff){
...
$new_staff = new CustomersControl();
                        ...
                        <header class="panel-heading">
                         ...
                         <div class="panel-body">
                            <div class="position-center">
                                <form role="form" action="customers_update.php?key=<?php echo $_GET['key']; ?>" method="post">
                                 <div class="form-group">
                                         <label for="exampleInputPassword1">Customers's ID</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="phone" value = "<?php echo $staff->phone; ?>" class="form-control" id="exampleInputEmail1" placeholder="Enter email">
                                    </div>
                                   <div class="form-group">

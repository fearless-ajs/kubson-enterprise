...
class UserControl{
    ...
    public function __construct() {
        ...
        if(isset($_POST['submit'])){
            ...
            if($this->validate_input($fullname, $email, $password, $verify_password, $checkbox) == true){
   ...
   //function that reset passwords
    ...
    public function validate_input($fullname, $email, $password, $verify_password, $checkbox){
               
              //checks for empty fields
              if(empty($fullname) || empty($email) || empty($password) || empty($verify_password)){        
                  $message = "You left a blank field";
                  $this->message = $message;
                  return false;
                    }

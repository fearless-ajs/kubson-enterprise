...
class MenControl extends ImageProcessor {
    public $message;
    public $id;
    public $name;
    public $price;
   ...
   //here the image is yo be processed
    ...
    public function __construct() {
        ...
        if(isset($_POST['submit'])){
            ...
            if($this->validate_input($itemName, $size, $price, $category, $description, $review,
    ...
    public function validate_input($itemName, $size, $price, $category, $description, $review,
                    $full_view, $front_view, $back_view, $side_view){
        //checks for empty fields
        if(empty($itemName) || empty($size) || empty($price) || empty($category) || empty($description) || empty($review)

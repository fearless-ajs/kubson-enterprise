...
require_once(LIB_PATH.DS. 'Helpers'.DS.'kids_image_processor.php');
//Class That controls the initialization

class KidsControl extends KidsImageProcessor {
    public $message;
    public $id;
    public $name;
    public $price;
   ...
   //here the image is yo be processed
    ...
    public function __construct() {
        ...
        if(isset($_POST['submit'])){
            ...
            if($this->validate_input($itemName, $price, $category,  $size, $description, $review,
    ...
    public function validate_input($itemName, $price, $category, $size, $description, $review,
                    $full_view, $front_view, $back_view, $side_view){
        //checks for empty fields
        if(empty($itemName) || empty($price) || empty($category) || empty($size) || empty($description) || empty($review)

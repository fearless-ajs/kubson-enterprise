...
class Staff extends DatabaseObject {
    ...
    protected static $table_name = "wardboy_nurse_tbl";
    protected static $db_fields = array('ID', 'W_N_Name', 'Category', 'Address', 'ContactNo', 'Email',
        'Qualifications', 'BloodGroup', 'DateOfJoining');

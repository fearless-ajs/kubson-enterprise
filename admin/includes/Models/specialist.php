...
class Specialist extends DatabaseObject {

    //our database columns are attributes individually
    //database column variables
    protected static $table_name = "specialist";
    protected static $db_fields = array('DoctorID', 'DoctorName', 'FatherName', 'Address', 'ContactNo', 'Email',
        'Qualifications', 'Specialization', 'Gender', 'BloodGroup', 'DateOfJoining', 'image_path');
    ...
    public function destroyStaff($ID){
        //First remove the database entry
        if($this->deleteDoctor($ID)){//if database entry is deleted successfully
            //Then remove the file
            return TRUE;
        } else {
            //database delete failed

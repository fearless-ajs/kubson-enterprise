...
class Patient extends DatabaseObject {
    ...
    protected static $table_name = "patientregistration";
    protected static $db_fields = array('PatientID', 'Patientname', 'Fathername', 'Address', 'ContactNo', 'Email',
        'Age', 'Gen', 'BG', 'Remarks');
    ...
    public function destroyStaff($ID){
        //First remove the database entry
        if($this->deletePatient($ID)){//if database entry is deleted successfully
            //Then remove the file
            return TRUE;
        } else {
            //database delete failed

...
class Order extends UserDatabaseObject {

    //our database columns are attributes individually
    //database column variables
    protected static $table_name = "orders";
    protected static $db_fields = array('id', 'item_id', 'item_name', 'ordered_date', 'customer_id', 'customer_name',
        'customer_phone', 'customer_email', 'delivery_status');

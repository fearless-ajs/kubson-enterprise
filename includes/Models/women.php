...
class Women extends UserDatabaseObject {

    //our database columns are attributes individually
    //database column variables
    protected static $table_name = "women";
    protected static $db_fields = array('id', 'name', 'price', 'size', 'category', 'description', 'review',
        'full_view', 'front_view', 'back_view', 'side_view', 'stock_date');
    ...
    public function destroyItem($ID){
        //First remove the database entry
        if($this->deleteItem($ID)){//if database entry is deleted successfully
            //Then remove the file
            return TRUE;
        } else {
            //database delete failed

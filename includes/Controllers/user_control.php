...
class UserControl{
    ...
    public function __construct() {
        ...
        if(isset($_POST['reg'])){
            ...
            if($this->validate_input($fullname, $email, $password, $verify_password, $phone) == true){
   ...
   //function that reset passwords
    ...
    public function validate_input($fullname, $email, $password, $verify_password, $phone){
               
              //checks for empty fields
              if(empty($fullname) || empty($email) || empty($password) || empty($verify_password) || empty($phone)){        
                  $message = "You left a blank field";
                  $this->message = $message;
                  return false;
                    }
                   ...
                   //check if the password matches and checkbox is checked
                   return $this->password_and_checkbox($password, $verify_password) == true ? true : false;
                    
    }
    
    //password verification and checkbox
    public function password_and_checkbox($password, $verify_password){
    ...
    public function deleteStaff(){
        ...
        if(isset($_GET['key'])){
            ...
            if($staffs && $staffs->destroyUser($_GET['key'])){
                ...
                $_GET['msg'] = "User Deleted Succesfully";
            } else {

...
define('SITE_ROOT', 'C:'.DS.'xampp'.DS.'htdocs'.DS.'kubson');
defined('LIB_PATH') ? null : define('LIB_PATH', SITE_ROOT.DS.'includes');
        ...
        require_once(LIB_PATH.DS.'Controllers'.DS.'cart_control.php');
       ...
       // require_once(LIB_PATH.DS.'Controllers'.DS.'patient_control.php');
        ...
        require_once(LIB_PATH.DS.'Controllers'.DS.'order_control.php');
      ...
      //  require_once(LIB_PATH.DS.'Models'.DS.'user.php');
        ...
        require_once(LIB_PATH.DS.'Models'.DS.'comment.php');
         require_once(LIB_PATH.DS.'Models'.DS.'cart.php');
       ...
       // require_once(LIB_PATH.DS.'Models'.DS.'specialist.php');
        ...
        require_once(LIB_PATH.DS.'Models'.DS.'customer.php');
        require_once(LIB_PATH.DS.'Models'.DS.'men.php');
        require_once(LIB_PATH.DS.'Models'.DS.'women.php');
        require_once(LIB_PATH.DS.'Models'.DS.'order.php');
